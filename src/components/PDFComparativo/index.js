            ...
            {props.data.length > 0 && props.range ?
              getPlanos().map((plano) => (
                <View style={styles.demonstrationCard} wrap={false}>
                  ...
                  <Text style={styles.demonstrationCardText}>VALOR: {plano.preco}</Text>
              ...
              <View style={styles.wrapper}>
                ...
                <View style={styles.logoWrapper}>
                  <View style={styles.textWrapper}>                  
                    ...
                    <Text>Telefone: {props.data.telefone_corretor}</Text>
                    <Text>Celular: {props.data.celular_corretor}</Text>
                    <Text>E-mail: {props.data.email_corretor}</Text>
                  </View>
                </View>
              </View>
