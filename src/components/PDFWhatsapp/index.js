...
export default function PDF(props) {
    let data = JSON.parse(atob(props.data))
            ...
            {data.planos.length > 0 ?
              data.planos.map((plano) => (
                <View style={styles.demonstrationCard} wrap={false}>
                  ...
                  <Text style={styles.demonstrationCardText}>QUANTIDADE DE VIDAS: {data.vidas}</Text>
                  <Text style={styles.demonstrationCardText}>PRAÇA: {data.contato.praca}</Text>
              ...
              <View style={styles.wrapperSecond}>
                ...
                <View style={styles.logoWrapper}>
                  <View style={styles.textWrapper}>                  
                    ...
                    <Text>E-mail: {data.contato.email_consultor}</Text>
                  </View>
                </View>
              </View>
